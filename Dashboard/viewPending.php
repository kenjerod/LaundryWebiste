...
<div class="container1">
    ...
    <div class="nav">
        ...
        <div class="dropdown-container">
        <a href="/LaundryWebsite/Dashboard/viewPending.php" id="active">View Pending</a>
        </div>
...
<div class="delete animate__animated animate__zoomIn">
    ...
    <p>
    <a href="deletePending.php?id=<?php echo $_GET['id']; ?>"> <button type="button" class="btn btn-warning">Yes</button></a>
    <a href="viewPending.php"><button type="button" class="btn btn-success">No</button></a>
    </p>
</div>
                                    ...
                                    $row1 = $result1->fetch_assoc();
                                      ...
                                      ?>
                                            <tr>
                                                ...
                                                <a href="viewPending.php?id=<?php echo $row['product_id']?>"><button type="button" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></button></a>
                                                </td>
