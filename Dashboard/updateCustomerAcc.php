...
$que="SELECT * FROM `customers_address` WHERE address_id = '".$_GET['id']."'";
...
<form class="row g-3" method="post">
  <div class="col-md-6">
    ...
    <input name="nameEdit" type="text" class="form-control" id="inputname" value="<?php echo  $fullname ?>" required>
  </div>
  <div class="col-md-6">
    <label for="inputcontact4" class="form-label">Contact No.</label>
    <input name="contactEdit" type="text" class="form-control" id="inputcontact4" value="<?php echo  $contact ?>" required>
  </div>
  <div class="col-12">
    <label for="inputAddress4" class="form-label">Address</label>
    <input name="addressEdit" type="text" class="form-control" id="inputAddress4" value="<?php echo  $address ?>" required>
  </div>
