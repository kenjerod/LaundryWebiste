<?php 
    ...
    require_once 'insertCustomer.php';
?>
...
<div class="container1">
    ...
    <div class="nav">
        ...
        <div class="dropdown-container">
        <a href="/LaundryWebsite/Dashboard/addCustomer.php" id="active">Add Customer</a>
...
<form class="row g-3" method="post">
  ...
  <div class="col-md-6">
    ...
    <input name="contact" type="text" class="form-control" id="inputcontact4" required>
  </div>
  <div class="col-12">
