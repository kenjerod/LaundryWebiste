...
<div class="container1">
    ...
    <div class="nav">
        ...
        <a href="/LaundryWebsite/Dashboard/viewCustomer.php" id="active">View Customer</a>
        </div>
        <span class="dropdown-btn">
...
<div class="delete animate__animated animate__zoomIn">
    ...
    <p>
    <a href="deleteCustomer.php?id=<?php echo $_GET['id']; ?>"> <button type="button" class="btn btn-warning">Yes</button></a>
    <a href="viewCustomer.php"><button type="button" class="btn btn-success">No</button></a>
    </p>
</div>
                                   ...
                                   while($row = $result->fetch_assoc()) { 
                                      ...
                                      ?>
                                            <tr>
                                                ...
                                                <a href="updateCustomerAcc.php?id=<?php echo $row['address_id']?>"><button type="button" class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i></button></a>
                                                <a href="viewCustomer.php?id=<?php echo $row['address_id']?>"><button type="button" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></button></a>
                                                </td>
