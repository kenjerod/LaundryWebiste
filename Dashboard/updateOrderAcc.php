...
<div class="container1">
    ...
    <div class="nav">
        ...
        <div class="dropdown-container">
        <a href="/LaundryWebsite/Dashboard/addServices.php">Add Services</a>
        <a href="/LaundryWebsite/Dashboard/viewServices.php">View Services</a>
        </div>
...
$que="SELECT * FROM `customers_products` WHERE product_id = '".$_GET['id']."'";
$result= mysqli_query($connection,$que);
if($row = mysqli_fetch_assoc($result)){
 
   
    $kilogram = $row['kilograms'];
...
<form class="row g-3" method="post">
    ...
    <select name="nameEdit" id="inputState" class="form-select" required="">
    ...
    <select name="typeCleanEdit" id="clean" class="form-select">
    ...
    <input name="kgEdit" type="text" class="form-control" id="kg"  value="<?php echo $kilogram ?>"required>
    </div>
    <div class="col-2">
    <label for="costPrice" class="form-label">Service Total</label>          
    <input type="text" id="costPrice" class="form-control" name="costpriceEdit" readonly> 
    </div>
...
<input type="text" id="specialPrice" class="form-control" name="specialpriceEdit" readonly>
</div>
...
<div class="form-check" >
  ...
  <input class="form-check-input" type="radio" name="flexRadioDefaultEdit" id="flexRadioDefault1" value="150">
  <label class="form-check-label" for="flexRadioDefault1">
    Yes P150
  </label>
</div>
<div class="form-check">
  <input class="form-check-input" type="radio" name="flexRadioDefaultEdit" id="flexRadioDefault2" value="0" checked>
...
<div class="col-3">
    ...
    <input type="text" id="ironPrice" class="form-control" name="ironpriceEdit" readonly> 
  </div>
...
<div class="form-check" id="radioPayment">
  <input class="form-check-input" type="radio" name="flexRadioDefault1Edit" id="flexRadioDefault3"  value="Cash on Delivery or Pick up" checked>
  <label class="form-check-label" for="flexRadioDefault13">
  Cash on Delivery or Pick up
  </label>
</div>
<div class="form-check">
  <input class="form-check-input" type="radio" name="flexRadioDefault1Edit" id="flexRadioDefault4" value="E/wallet">
  <label class="form-check-label" for="flexRadioDefault24">
  e-Wallet
  </label>
</div>
<div class="form-check">
  <input class="form-check-input" type="radio" name="flexRadioDefault1Edit" id="flexRadioDefault5" value="Credit/Debit Card">
...
<div id="price">
            ...
            <p> Total : <input type="text" class="form-control" id="price1" name="totalpriceEdit" readonly> </p>
...
<script>
      ...
      var press = document.getElementsByName("flexRadioDefaultEdit");
