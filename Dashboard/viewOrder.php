...
<div class="container1">
    ...
    <div class="nav">
        ...
        <a href="/LaundryWebsite/Dashboard/viewOrder.php" id="active">View Order</a>
        </div>
        <span class="dropdown-btn">
...
<div class="delete animate__animated animate__zoomIn">
    ...
    <p>
    <a href="deleteOrder.php?id=<?php echo $_GET['id']; ?>"> <button type="button" class="btn btn-warning">Yes</button></a>
    <a href="viewOrder.php"><button type="button" class="btn btn-success">No</button></a>
    </p>
</div>
                                    ...
                                    $row1 = $result1->fetch_assoc();
                                      ...
                                      ?>
                                            <tr>
                                                ...
                                                <?php if($row['status']==0) 
                                                { ?>
                                                    <a href="completeOrder.php?id=<?php echo $row['product_id']?>"><button type="button" class="btn btn-xs btn-warning" ><i class="fa fa-exchange"></i></button></a>
                                                <?php }
                                                
                                                ?>
                                                <a href="updateOrderAcc.php?id=<?php echo $row['product_id']?>"><button type="button" class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i></button></a>
                                                <a href="viewOrder.php?id=<?php echo $row['product_id']?>"><button type="button" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></button></a>
                                                </td>
